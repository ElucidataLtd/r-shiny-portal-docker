...
RUN install2.r bit64 data.table DiagrammeR DT futile.logger future ggplot2 glue listviewer openxlsx plotly pool promises r2d3 rhandsontable rjson RPostgres shiny shinyBS shinydashboard shinyjqui shinyjs shinyWidgets testthat yaml XML
